...
def main():   
    ...
    df = pd.read_excel(r"D:\Projects\ETL\ETL\source_file\ml_sales\Sales for Analysis.xlsx", sheet_name="Sales2")
    df_long = detect_and_reshape(df)
    ...
    splits = {
        ...
        'date_col': 'Date',
        'value_col': 'Sales',
        'freq': 'MS',         # 'MS' for monthly, 'D' for daily, etc.
